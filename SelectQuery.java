...
public class SelectQuery {
	...
	{ 
		RandomAccessFile IndxFile=null;
		try
		{
			...
			{	
				...
				case "LONG":
					...
					columnIndex.put(keyLong, values);
					break;
				...
				case "SHORT":
					...
					columnIndex.put(keyShort, values);
					break;
				...
				case "FLOAT":
					...
					columnIndex.put(keyFloat, values);
					break;
				...
				case "DOUBLE":
					...
					columnIndex.put(keyDouble, values);
					break;
					
				case "byte":
				case "BYTE":
					short keyByte=IndxFile.readByte();
					no_of_values=IndxFile.readInt(); 
					...
					columnIndex.put(keyByte, values);
					break;
				...
				case "DATE":
					...
					if(whereSpecified==false || checkCondn(formatter.format(keyDate)+"","date"))
						{
							columnIndex.put(keyDate, values);
						}
				...
				case "DATETIME":
				    ...
				    if(whereSpecified==false || checkCondn(formatter2.format(keyDateTime)+"","date"))
						{
							columnIndex.put(keyDateTime, values);
						}
				...
				default:				
					...
					columnIndex.put(keyChar, values);
					}
					break;
				}
